...
//3. p태그로 감싸진 name과 about을 렌더링하세요.
  ...
  <section class="bio">
    ...
    <div class="favorite-info">
      ...
      <div class="favorite">${favoriteInfo[0] ? favoriteInfo[0] : 'favorite or interest' }</div>
      <div class="favorite">${favoriteInfo[1] ? favoriteInfo[1] : 'favorite or interest' }</div>
      <div class="favorite">${favoriteInfo[2] ? favoriteInfo[2] : 'favorite or interest' }</div>
    </div>
    ${EditBioForm()}
    ${EditFavorite()}
  </section>
